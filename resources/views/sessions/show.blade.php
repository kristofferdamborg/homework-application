        ...
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                ...
                <div class="dropdown">
                  ...
                  <ul style="left: 0!important; width: 100px;" class="dropdown-menu">
                        ...
                        <div id="{{ $HW->id }}" class="modal fade" role="dialog">
                          <div class="modal-dialog">
                            ...
                            <div class="modal-content">
                              ...
                              @role('teacher')
                                <a style="min-width: 100px; float: left; margin-right: 5px;" class="btn btn-primary btn-lg" href="{{ route('homework.edit', $HW->id) }}"><span class="glyphicon glyphicon-wrench" aria-hidden="true"></span> Rediger</a>

                                <form action="{{ URL::route('homework.destroy', $HW->id) }}" method="POST"><input type="hidden" name="_method" value="DELETE">
                                <input type="hidden" name="_token" value="{{ csrf_token() }}"></input>
                                <button style="min-width: 100px; float: left;" class="btn btn-danger btn-lg"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span> Slet</button>
                                <button style="min-width: 100px; float: right;" type="button" class="btn btn-default btn-lg" data-dismiss="modal">Luk</button>
                                @endrole
                              </div>
                            </div>
